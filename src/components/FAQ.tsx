...
const faqData: FAQItem[] = [
    ...
    {
        question: "영어 닉네임을 만들 때 숫자를 넣어도 되나요?",
        answer: "게임 닉네임의 경우 Ares77, Thor99처럼 신화 이름에 숫자를 붙이는 방식이 자주 쓰입니다. 단, 인스타그램·유튜브 등 SNS 닉네임에는 숫자를 최소화하는 것이 기억하기 쉽고 세련된 인상을 줍니다. 용도에 따라 선택하세요."
    },
    {
        question: "롤(리그 오브 레전드) 닉네임 규칙은 무엇인가요?",
        answer: "롤(LoL) 닉네임은 3~16자 이내, 영문·숫자·특수문자(일부) 사용 가능합니다. 공백은 한 번만 허용되며, 연속 공백이나 공백으로 시작·끝나는 닉네임은 불가합니다. 이미 사용 중인 닉네임은 등록이 안 되니 중복 확인이 필요합니다."
    },
    {
        question: "인스타그램 사용자명과 닉네임의 차이는 무엇인가요?",
        answer: "인스타그램 '사용자명'(@뒤의 아이디)은 로그인에 사용되는 고유 식별자로 영문·숫자·밑줄·마침표만 가능합니다. '닉네임(이름)'은 프로필에 표시되는 이름으로 한글·이모지 포함 자유롭게 설정 가능합니다. 두 가지 모두 개성 있게 설정하면 팔로워에게 좋은 인상을 줄 수 있습니다."
    }
];
